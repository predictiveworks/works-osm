 ...
 * output channels for OSM Beat implementation
 */
object BeatSinks {
   ...
   * use cases somewhat.
   */
  implicit val system: ActorSystem = ActorSystem(s"osm-beat-channels-$uuid")
