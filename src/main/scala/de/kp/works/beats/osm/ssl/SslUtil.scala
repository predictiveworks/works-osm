package de.kp.works.beats.osm.ssl
...
object SslUtil {
  ...
  def getStoreSslSocketFactory(
    ...
    getStoreSslSocketFactory(keystoreFile, keystoreType,
      keystorePassword, keystoreAlgorithm, TLS_VERSION)
  ...
  def getStoreSslSocketFactory(
    ...
    keyManagers = getStoreKeyManagerFactory(keystoreFile, keystoreType,
      keystorePassword, keystoreAlgorithm).getKeyManagers
  ...
  def getStoreSslSocketFactory(keystoreFile: String, keystoreType: String, keystorePassword: String,
                               keystoreAlgorithm: String, truststoreFile: String, truststoreType: String,
                               truststorePassword: String, truststoreAlgorithm: String, tlsVersion: String): SSLSocketFactory = {
  ...
  def getCertFileSslSocketFactory(caCrtFile: String, crtFile: String, keyFile: String,
                                  password: String, tlsVersion: String): SSLSocketFactory = {
  ...
  def getCertSslSocketFactory(caCert: X509Certificate, cert: X509Certificate,
                              privateKey: PrivateKey, password: String): SSLSocketFactory =
    getCertSslSocketFactory(caCert, cert, privateKey, password, TLS_VERSION)

  def getCertSslSocketFactory(caCert: X509Certificate, cert: X509Certificate, privateKey: PrivateKey,
                              password: String, tlsVersion: String): SSLSocketFactory = {
  ...
  def getStoreKeyManagerFactory(keystoreFile: String, keystoreType: String,
                                keystorePassword: String, keystoreAlgorithm: String): KeyManagerFactory = {
  ...
  def getStoreTrustManagerFactory(truststoreFile: String, truststoreType: String,
                                  truststorePassword: String, truststoreAlgorithm: String): TrustManagerFactory = {
